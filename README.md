...
<p align="center" style="background-color:#0D0D0D; padding:20px; border-radius:15px;">
  <img 
    src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=400&size=28&duration=3200&pause=800&center=true&vCenter=true&width=900&color=00FFAB;00CFFF;8A2BE2;FF00FF;FF0080&lines=💡+Code.+Build.+Learn.+Repeat.;🔥+Specialized+in+SaaS+%26+Real-Time+Systems.;🌱+Always+Learning+and+Improving+Every+Day.;🤝+Open+to+Mid-Level+Laravel%2FPHP+Backend+Roles.;🚀+Driven+to+Create+Impactful+Products."
...
| 🚚 **Osool Delivery App** *(In Progress)* | Delivery app with real-time distance calculation and Reverb notifications | Laravel, PHP, MySQL, Reverb |
| 🛠️ **Mandoop App** | Support developer — resolved production issues, added real-time notifications, ensured 99% uptime | Laravel, PHP |
| 🕌 **Bayt Alkhyata** | Secure APIs for courses and enrollments on a national training platform | Laravel, PHP, MySQL |
| 🎬 [**Movie Recommendation App**](https://github.com/Ahmed-Hassan-1/Movie-app) | Responsive UI with search, filter, pagination, and back-end endpoints | React.js, Bootstrap |
| 🛍 [**E-commerce Using React**](https://github.com/Ahmed-Hassan-1/Basic-E-commerce) | Full e-commerce app with cart, Stripe/PayPal payments, and Redux Persist auth | React, Redux, Vite, Material-UI |
...
![RESTful APIs](https://img.shields.io/badge/RESTful_APIs-0096D6?style=for-the-badge&logo=postman&logoColor=white)
